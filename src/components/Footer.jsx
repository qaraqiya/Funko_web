...
const Footer = () => {
  return (
    <div className="bg-black text-white py-8">
      <div className="container mx-auto flex flex-col md:flex-row justify-between gap-x-5 items-center px-4 sm:px-8 lg:px-20">
        
        {/* Account Section */}
        <div className="flex flex-col space-y-1 text-center md:text-left mb-6 md:mb-0">
